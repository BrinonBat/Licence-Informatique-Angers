...
CREATE TRIGGER insertOnAction AFTER INSERT ON ACTION
...
INSERT INTO ACTION VALUES
	...
	((SELECT P FROM PERSONNE P WHERE P.NumSecu=001),(SELECT S FROM SOCIETE S WHERE S.NOMSOC='Le Renouveau Allemand'),'1998-05-21',4,'achat');
