...
dpeda(_P,[],[],[],[]).
dpeda(P,[X|L],PPP,[X|EP],PGP):-P=X,dpeda(P,L,PPP,EP,PGP).
dpeda(P,[X|L],PPP,EP,[X|PGP]):-inf_st(P,X),dpeda(P,L,PPP,EP,PGP).
dpeda(P,[X|L],[X|PPP],EP,PGP):-inf_st(X,P),dpeda(P,L,PPP,EP,PGP).
